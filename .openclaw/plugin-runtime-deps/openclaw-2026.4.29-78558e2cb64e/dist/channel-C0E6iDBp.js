...
import { o as hasConfiguredSecretInput, u as normalizeSecretInputString } from "./types.secrets-BHp0Y_k0.js";
import { n as normalizeAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-vYgQddVH.js";
import { i as createLazyRuntimeNamedExport } from "./lazy-runtime-BvM5m8r7.js";
import { a as createActionGate, f as readNumberParam, g as readStringParam, l as jsonResult, p as readReactionParams } from "./common-CfyIgNqB.js";
import { t as readBooleanParam } from "./boolean-param-DAcxNeQ8.js";
import { l as createScopedDmSecurityResolver, s as createScopedChannelConfigAdapter, t as adaptScopedAccountAccessor } from "./channel-config-helpers-mYqAcdtC.js";
import "./text-runtime-ysqqY1vr.js";
import { r as describeWebhookAccountSnapshot } from "./account-helpers-D258dZ17.js";
import { a as createSetupInputPresenceValidator, l as patchScopedAccountConfig, u as prepareScopedSetupConfig } from "./setup-helpers-C80aTqI-.js";
import { i as createChatChannelPlugin, t as buildChannelOutboundSessionRoute, u as stripChannelTargetPrefix } from "./core-D416gENI.js";
import "./channel-core-BVsWr-0s.js";
import { t as createAccountStatusSink } from "./channel-lifecycle.core-DtemdXWJ.js";
import { n as formatNormalizedAllowFromEntries } from "./allow-from-oL1xKn-I.js";
import { T as projectAccountWarningCollector, x as createOpenGroupPolicyRestrictSendersWarningCollector } from "./channel-policy-BdSmbFNg.js";
import { a as createAllowFromSection, d as createPromptParsedAllowFromForAccount, f as createStandardChannelSetupStatus, t as addWildcardAllowFrom } from "./setup-wizard-helpers-4xSddeax.js";
...
import { d as createDefaultChannelRuntimeState, h as collectIssuesForEnabledAccounts, i as buildProbeChannelStatusSummary, u as createComputedAccountStatusAdapter } from "./status-helpers-B9xc_mSy.js";
...
import { A as parseBlueBubblesAllowTarget, D as looksLikeBlueBubblesTargetId, E as looksLikeBlueBubblesExplicitTargetId, F as resolveBlueBubblesEffectiveAllowPrivateNetwork, I as resolveDefaultBlueBubblesAccountId, N as listBlueBubblesAccountIds, O as normalizeBlueBubblesHandle, P as resolveBlueBubblesAccount, R as normalizeBlueBubblesServerUrl, S as extractHandleFromChatGuid, a as isMacOS26OrHigher, j as parseBlueBubblesTarget, k as normalizeBlueBubblesMessagingTarget, n as getCachedBlueBubblesPrivateApiStatus, u as asRecord, w as inferBlueBubblesTargetChatType, x as buildBlueBubblesChatContextFromTarget, y as resolveGroupFlagFromChatGuid } from "./probe-BosU90Ur.js";
import "./secret-input-BZhMUzCs.js";
import { t as BlueBubblesChannelConfigSchema } from "./config-schema-ByUClxOs.js";
import { n as createBlueBubblesConversationBindingManager } from "./conversation-bindings-Dhnqmxcc.js";
import { n as normalizeBlueBubblesAcpConversationId, r as resolveBlueBubblesConversationIdFromTarget, t as matchBlueBubblesAcpConversation } from "./conversation-id-Dgnh5isv.js";
...
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-Bo9Ke-pB.js";
import { t as DEFAULT_WEBHOOK_PATH } from "./webhook-shared-9y4Sx5CY.js";
...
const loadBlueBubblesActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-Ce0M6k5Y.js"), "blueBubblesActionsRuntime");
...
function buildChatContextFromActionParams(params) {
	...
	const targetContext = buildBlueBubblesChatContextFromTarget(readStringParam(params.actionParams, "to") ?? readStringParam(params.actionParams, "target") ?? params.currentChannelId ?? void 0);
	return {
...
function resolveBlueBubblesOutboundSessionRoute(params) {
	...
	const groupFromChatGuid = parsed.kind === "chat_guid" ? resolveGroupFlagFromChatGuid(parsed.chatGuid) : void 0;
	const isGroup = parsed.kind === "chat_id" || parsed.kind === "chat_identifier" ? true : parsed.kind === "chat_guid" ? groupFromChatGuid ?? true : false;
	const dmHandleFromChatGuid = parsed.kind === "chat_guid" && groupFromChatGuid === false ? extractHandleFromChatGuid(parsed.chatGuid) : null;
	const peerId = parsed.kind === "chat_id" ? String(parsed.chatId) : parsed.kind === "chat_guid" ? dmHandleFromChatGuid ?? parsed.chatGuid : parsed.kind === "chat_identifier" ? parsed.chatIdentifier : parsed.to;
...
const loadBlueBubblesChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-DcyJlUh6.js"), "blueBubblesChannelRuntime");
	...
	outbound: {
		...
		attachedResults: {
			...
			sendText: async ({ cfg, to, text, accountId, replyToId }) => {
				...
				const replyToMessageGuid = rawReplyToId ? runtime.resolveBlueBubblesMessageId(rawReplyToId, {
					requireKnownShortId: true,

...
import "./accounts-DD0D9_wb.js";
import "./runtime-api-BFq2GrJQ.js";
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-Dg2ojEu2.js";
import { t as sendMessageZalo } from "./send-B-avOkP5.js";
...
async function notifyZaloPairingApproval(params) {
	const { resolveZaloAccount } = await import("./accounts-EiRBSJmP.js");
...
async function startZaloGatewayAccount(ctx) {
	...
	const { monitorZaloProvider } = await import("./monitor-C6oI3fAu.js");

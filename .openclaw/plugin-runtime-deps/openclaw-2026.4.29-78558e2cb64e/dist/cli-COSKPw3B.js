import { a as fetchGoogleMeetSpace, i as fetchGoogleMeetAttendance, n as createGoogleMeetSpace, o as fetchLatestGoogleMeetConferenceRecord, r as fetchGoogleMeetArtifacts, t as buildGoogleMeetPreflightReport } from "./meet-DTrZjq4w.js";
...
import { a as buildGoogleMeetAuthUrl, c as exchangeGoogleMeetAuthCode, f as waitForGoogleMeetAuthCode, o as createGoogleMeetOAuthState, s as createGoogleMeetPkce, u as resolveGoogleMeetAccessToken } from "./oauth-BxTHNh1B.js";
...
function registerGoogleMeetCli(params) {
	...
	root.command("setup").description("Show Google Meet transport setup status").option("--transport <transport>", "Transport to check: chrome, chrome-node, or twilio").option("--mode <mode>", "Mode to check: realtime or transcribe").option("--json", "Print JSON output", false).action(async (options) => {

import { p as shouldMigrateStateFromPath } from "./argv-BT86vRPw.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-DZNkK4lq.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-DTLSPjFC.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-CBf1lCZs.js"),
		import("./utils-DfOTa58u.js"),
		import("./command-format-BL3wkhq1.js")
	]);
	const rich = isRich();

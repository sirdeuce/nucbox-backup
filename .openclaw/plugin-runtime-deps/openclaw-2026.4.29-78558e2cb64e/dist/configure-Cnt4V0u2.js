...
import { t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-B2cMK-wd.js";
import { i as formatErrorMessage } from "./errors-RZvg4nzL.js";
import { t as formatCliCommand } from "./command-format-BORwwHyH.js";
import { g as shortenHomePath, p as resolveUserPath, x as isPlainObject } from "./utils-DvkbxKCZ.js";
import { c as isValidEnvSecretRefId, s as isSecretRef } from "./types.secrets-BHp0Y_k0.js";
...
import { l as resolvePluginContributionOwners } from "./plugin-registry-x83fIWqx.js";
...
import { a as findTailscaleBinary } from "./tailscale-BP2VZXdE.js";
...
import { t as ConfigMutationConflictError } from "./mutate-DfVitNFo.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-C-vvBtdm.js";
import { t as randomToken } from "./random-token-CS0Mkk7h.js";
...
import { a as guardCancel, c as normalizeGatewayTokenInput, f as summarizeExistingConfig, m as waitForGatewayReachable, n as applyWizardMetadata, p as validateGatewayPasswordInput, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE, u as probeGatewayReachable } from "./onboard-helpers-VVLMiuiD.js";
import { t as promptAuthChoiceGrouped } from "./auth-choice-prompt-8etKCnGD.js";
import { n as applyAuthChoice } from "./auth-choice-C9-f87u6.js";
...
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-DAvjxGIb.js";
import { n as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-Cl8S50oF.js";
import { i as promptModelAllowlist, n as applyModelFallbacksFromSelection, r as promptDefaultModel, t as applyModelAllowlist } from "./model-picker-Dy0YvxYk.js";
import { t as promptCustomApiConfig } from "./onboard-custom-x-s1DsDS.js";
import { a as maybeAddTailnetOriginToControlUiAllowedOrigins, i as TAILSCALE_MISSING_BIN_NOTE_LINES, n as TAILSCALE_DOCS_LINES, r as TAILSCALE_EXPOSURE_OPTIONS, t as validateIPv4AddressInput } from "./ipv4-Cso8LDVc.js";
...
function loadSetupPluginConfigModule() {
	setupPluginConfigModulePromise ??= import("./setup.plugin-config-COxHRgZ_.js");
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
	...
	const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-Dd7nhqk-.js");
	...
	if (enableSearch) {
		...
		if (configureManagedProvider) {
			const { resolveSearchProviderOptions, setupSearch } = await import("./onboard-search-DgcP0e98.js");

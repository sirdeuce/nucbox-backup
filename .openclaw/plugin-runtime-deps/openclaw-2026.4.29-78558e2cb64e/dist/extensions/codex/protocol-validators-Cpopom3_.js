...
var ThreadResumeResponse_default = {
	...
	definitions: {
		...
		"FileSystemSpecialPath": { "oneOf": [
			...
			{
				"properties": { "kind": {
					"enum": ["current_working_directory"],
					"type": "string"
				} },
				"required": ["kind"],
		...
		"PermissionProfile": {
			"properties": {
				"fileSystem": { "anyOf": [{ "$ref": "#/definitions/PermissionProfileFileSystemPermissions" }, { "type": "null" }] },
				"network": { "anyOf": [{ "$ref": "#/definitions/PermissionProfileNetworkPermissions" }, { "type": "null" }] }
			},
			"type": "object"
		},
		...
		"SandboxPolicy": { "oneOf": [
			...
			},
			{
				"properties": {
					"access": {
						"allOf": [{ "$ref": "#/definitions/ReadOnlyAccess" }],
...
//#endregion
export { readCodexErrorNotification as a, readCodexTurnCompletedNotification as c, readCodexDynamicToolCallParams as i, assertCodexThreadStartResponse as n, readCodexModelListResponse as o, assertCodexTurnStartResponse as r, readCodexTurn as s, assertCodexThreadResumeResponse as t };

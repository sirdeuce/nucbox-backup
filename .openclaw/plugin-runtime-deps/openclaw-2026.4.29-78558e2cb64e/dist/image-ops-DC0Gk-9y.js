...
let mediaAttachmentImageOpsPromise = null;
...
async function loadMediaAttachmentImageOps() {
	if (!mediaAttachmentImageOpsPromise) mediaAttachmentImageOpsPromise = Promise.resolve().then(async () => {
		const { loadBundledPluginPublicArtifactModuleSync } = await import("./public-surface-loader-DyiRUSaJ.js");

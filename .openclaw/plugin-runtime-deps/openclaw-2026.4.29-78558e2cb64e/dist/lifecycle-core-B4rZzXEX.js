import { d as resolveIsNixMode } from "./paths-B2cMK-wd.js";
...
import { n as isGatewaySecretRefUnavailableError, t as GatewaySecretRefUnavailableError } from "./credentials-BiQRb9SO.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BHDeLiIA.js";
import { l as readBestEffortConfig, u as readConfigFileSnapshot } from "./io-DaEsZ_NY.js";
...
import { r as checkTokenDrift } from "./service-audit-B7DL12bi.js";
import "./config-DMj91OAB.js";
import { i as startGatewayService, t as describeGatewayServiceRestart } from "./service-CvDq_E8t.js";
import { o as renderSystemdUnavailableHints } from "./runtime-hints-BJHp__ar.js";
import { t as isWSL } from "./wsl-B-1FAT4i.js";
import { i as filterContainerGenericHints, m as createDaemonActionContext, p as buildDaemonServiceSnapshot } from "./shared-CuEo3RhL.js";
import { n as formatConfigIssueLines } from "./issue-format-C4PaL3KR.js";
import { h as writeGatewayRestartIntentSync, t as clearGatewayRestartIntentSync } from "./restart-BxfYpM3d.js";
...
async function runServiceRestart(params) {
	...
	try {
		...
		if (loaded) {
			...
			if (params.serviceNoun === "Gateway") wroteRestartIntent = writeGatewayRestartIntentSync({ targetPid: (await params.service.readRuntime(process.env).catch(() => null))?.pid });
			try {

...
import { i as extractFirstTextBlock } from "./chat-message-content-Cs727eoM.js";
...
var OpenClawChannelBridge = class {
	...
	async start() {
		...
		const [{ resolveGatewayClientBootstrap }, { GatewayClient: GatewayClientCtor }, { startGatewayClientWhenEventLoopReady }, { APPROVALS_SCOPE, READ_SCOPE, WRITE_SCOPE }, { GATEWAY_CLIENT_MODES, GATEWAY_CLIENT_NAMES }] = await Promise.all([
			import("./client-bootstrap-BipFYLZd.js"),
			import("./client-Bt1E68LA.js"),
			import("./client-start-readiness-ssb83IY2.js"),
			import("./method-scopes-BFjhs-Tf.js"),
			import("./client-info-BJ5RRbxR.js")
		]);

...
export declare const OPENCLAW_DIAGNOSTICS_TIMELINE_SCHEMA_VERSION = "openclaw.diagnostics.v1";
export type DiagnosticsTimelineEventType = "span.start" | "span.end" | "span.error" | "mark" | "eventLoop.sample" | "provider.request" | "childProcess.exit";

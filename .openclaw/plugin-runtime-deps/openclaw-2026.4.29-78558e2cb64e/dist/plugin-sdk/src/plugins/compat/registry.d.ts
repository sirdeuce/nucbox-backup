...
export declare const PLUGIN_COMPAT_RECORDS: readonly [{
    ...
    readonly code: "legacy-implicit-startup-sidecar";
    readonly status: "deprecated";
    readonly owner: "plugin-execution";
    readonly introduced: "2026-04-28";
    readonly deprecated: "2026-04-28";
    readonly warningStarts: "2026-04-28";
    readonly removeAfter: "2026-07-28";
    readonly replacement: "`activation.onStartup: true` for startup work or `activation.onStartup: false` for inert plugins";
    readonly docsPath: "/plugins/manifest";
    readonly surfaces: readonly ["Gateway startup plugin planning", "openclaw.plugin.json activation"];
    readonly diagnostics: readonly ["plugin compatibility notice"];
    readonly tests: readonly ["src/plugins/channel-plugin-ids.test.ts", "src/plugins/installed-plugin-index.test.ts"];
}, {

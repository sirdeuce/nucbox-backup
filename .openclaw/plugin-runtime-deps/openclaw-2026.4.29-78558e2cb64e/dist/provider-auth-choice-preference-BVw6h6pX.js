...
import { r as normalizeLegacyOnboardAuthChoice } from "./auth-choice-legacy-COuZ8yqM.js";
...
async function resolvePreferredProviderForAuthChoice(params) {
	...
	const { resolveProviderPluginChoice, resolvePluginProviders } = await import("./provider-auth-choice.runtime-Bmsb4Ldp.js");

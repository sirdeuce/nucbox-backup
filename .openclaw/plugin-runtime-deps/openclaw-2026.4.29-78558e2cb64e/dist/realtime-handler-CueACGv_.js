...
import { f as buildRealtimeVoiceAgentConsultWorkingResponse, t as createRealtimeVoiceBridgeSession } from "./session-runtime-pKRTzlWC.js";
...
<Response>
  <Connect>
	...
	async executeToolCall(bridge, callId, bridgeCallId, name, args) {
		...
		if (handler && name === "openclaw_agent_consult" && bridge.bridge.supportsToolResultContinuation) bridge.submitToolResult(bridgeCallId, buildRealtimeVoiceAgentConsultWorkingResponse("caller"), { willContinue: true });

...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-BVyP1919.js";
import { _ as resolveRealtimeVoiceAgentConsultTools, c as REALTIME_VOICE_AGENT_CONSULT_TOOL_NAME, v as resolveRealtimeVoiceAgentConsultToolsAllow } from "./session-runtime-pKRTzlWC.js";
import { o as consultRealtimeVoiceAgent, t as convertPcmToMulaw8k } from "./realtime-voice-faqTPUPv.js";
...
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-VCbhDyb3.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-vNoXqR4K.js";
import { t as resolveVoiceResponseModel } from "./response-model-C5ikTpQf.js";
import { t as isProviderStatusTerminal } from "./call-status-BjA4pxC1.js";
import { t as getHeader } from "./http-headers-CT_iz5TT.js";
...
function loadRealtimeTranscriptionRuntime() {
	realtimeTranscriptionRuntimePromise ??= import("./realtime-transcription.runtime-sPOBYntU.js");
	return realtimeTranscriptionRuntimePromise;
}
function loadResponseGeneratorModule() {
	responseGeneratorModulePromise ??= import("./response-generator-BQW1-seb.js");
...
function loadTelnyxProvider() {
	telnyxProviderPromise ??= import("./telnyx-Zsf3lBdx.js");
	return telnyxProviderPromise;
}
function loadTwilioProvider() {
	twilioProviderPromise ??= import("./twilio-BDZywjaz.js");
	return twilioProviderPromise;
}
function loadPlivoProvider() {
	plivoProviderPromise ??= import("./plivo-Yt1ShGXV.js");
	return plivoProviderPromise;
}
function loadMockProvider() {
	mockProviderPromise ??= import("./mock-KOYbjeJ5.js");
	return mockProviderPromise;
}
function loadRealtimeVoiceRuntime() {
	realtimeVoiceRuntimePromise ??= import("./realtime-voice.runtime-DhCEmQrG.js");
	return realtimeVoiceRuntimePromise;
}
function loadRealtimeHandler() {
	realtimeHandlerPromise ??= import("./realtime-handler-CueACGv_.js");

...
import { a as parseApiErrorInfo, i as isCloudflareOrHtmlErrorPage, n as extractLeadingHttpStatus, o as parseApiErrorPayload, r as formatRawAssistantErrorForUi } from "./assistant-error-format-eT-WeDfo.js";
import { t as coerceChatContentText } from "./chat-content-B_2NtoZZ.js";
import { c as isTimeoutErrorMessage, i as isOverloadedErrorMessage, o as isRateLimitErrorMessage, r as isBillingErrorMessage } from "./failover-matches-BFEi8MTj.js";
...
function sanitizeUserFacingText(text, opts) {
	...
	const withoutPlaceholder = stripToolCallsOmittedPlaceholderLines(stripInboundMetadata(stripInternalRuntimeContext(stripFinalTagsFromText(raw))));
	...
	return collapseConsecutiveDuplicateBlocks(withoutPlaceholder.replace(/^(?:[ \t]*\r?\n)+/, ""));
}
//#endregion

...
import { d as createIcaclsResetCommand, f as formatIcaclsResetCommand } from "./audit-fs-DNmz2Ev9.js";
import { c as normalizeAgentId } from "./session-key-Bd0xquXF.js";
import { S as resolveDefaultAgentId } from "./agent-scope-Df_s1jDI.js";
import { i as getRuntimeConfig, r as createConfigIO } from "./io-DaEsZ_NY.js";
...
import { s as getSecurityAuditCommandSecretTargetIds } from "./command-secret-targets-BqlyieXD.js";
import { t as formatHelpExamples } from "./help-format-B4j9ozVX.js";
import { t as runSecurityAudit } from "./audit-BUnh7jdS.js";
...
async function collectChannelSecurityConfigFixMutation(params) {
	...
	const collectPlugins = async () => {
		...
		try {
			...
			const { listBundledChannelPlugins } = await import("./bundled-LZ6Bba7D.js");

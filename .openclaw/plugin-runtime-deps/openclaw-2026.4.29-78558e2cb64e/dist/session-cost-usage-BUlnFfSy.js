...
import { c as isUsageCountedSessionTranscriptFileName, d as parseUsageCountedSessionIdFromFileName, i as isSessionArchiveArtifactName, r as isPrimarySessionTranscriptFileName, u as parseSessionArchiveTimestamp } from "./artifacts-DjWkGvSk.js";
import { i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent } from "./paths-CEkZRIk4.js";
...
import { d as countToolResults, f as extractToolCallNames, l as stripEnvelope, u as stripMessageIdHints } from "./session-utils.fs-BUVSFzfH.js";
	...
	await scanTranscriptFile({
		...
		onEntry: (entry) => {
			...
			if (entry.timestamp) {
				...
				const quarterIndex = Math.floor((entry.timestamp.getUTCHours() * 60 + entry.timestamp.getUTCMinutes()) / 15);

...
import { S as resolveDefaultAgentId, a as resolveAgentIdByWorkspacePath, x as resolveAgentWorkspaceDir } from "./agent-scope-Df_s1jDI.js";
import { i as getRuntimeConfig } from "./io-DaEsZ_NY.js";
import "./config-DMj91OAB.js";
import { t as resolveOptionFromCommand } from "./cli-utils-CYzj_K_F.js";
import { n as renderTable, t as getTerminalTableWidth } from "./table-XEH6nS3a.js";
import { i as updateSkillsFromClawHub, n as readTrackedClawHubSkillSlugs, r as searchSkillsFromClawHub, t as installSkillFromClawHub } from "./skills-clawhub-C8ZdHj1n.js";
...
function resolveSkillsWorkspace(options) {
	...
	return {
		config,
		workspaceDir: resolveAgentWorkspaceDir(config, explicitAgentId ?? inferredAgentId ?? resolveDefaultAgentId(config))
	};
}
...
async function loadSkillsStatusReport(options) {
	...
	const { buildWorkspaceSkillStatus } = await import("./skills-status-DGdHyE7Z.js");
...
function registerSkillsCli(program) {
	...
	skills.command("check").description("Check which skills are ready vs missing requirements").option("--json", "Output as JSON", false).option("--agent <id>", "Target agent workspace (defaults to cwd-inferred, then default agent)").action(async (opts, command) => {

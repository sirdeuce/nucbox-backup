...
import { i as parseDotPath } from "./shared-D3dOhD6q.js";
import { n as getPath } from "./path-utils-2yGwtueR.js";
...
function listBundledWebProviderSecretTargetRegistryEntries() {
	const entries = [];
	for (const record of loadPluginManifestRegistryForPluginRegistry({ includeDisabled: true }).plugins) {
...
function listBundledPluginConfigSecretTargetRegistryEntries() {
	...
	for (const record of listBundledPluginMetadata({
		...
		for (const secretInput of secretInputs) {
			const entry = createPluginOpenClawConfigSecretTargetEntry(record.manifest.id, secretInput.path);
...
//#endregion
export { listAuthProfileSecretTargetEntries as a, resolvePlanTargetAgainstRegistry as c, isKnownSecretTargetId as i, loadBundledChannelSecretContractApi as l, discoverConfigSecretTargets as n, listSecretTargetRegistryEntries as o, discoverConfigSecretTargetsByIds as r, resolveConfigSecretTargetByPath as s, discoverAuthProfileSecretTargets as t };

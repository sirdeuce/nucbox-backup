...
import { C as SecretInputSchema, E as SecretsConfigSchema, L as createAllowDenyChannelRulesSchema, P as TypingModeSchema, _ as NativeCommandsSettingSchema, c as GroupChatSchema, d as HumanDelaySchema, g as ModelsConfigSchema, i as ContextVisibilityModeSchema, j as TtsConfigSchema, k as TranscribeAudioSchema, l as GroupPolicySchema, n as BlockStreamingCoalesceSchema, p as InboundDebounceSchema, r as CliBackendSchema, t as BlockStreamingChunkSchema, u as HexColorSchema, y as QueueSchema } from "./zod-schema.core-CDjzQmUR.js";
import { t as sensitive } from "./zod-schema.sensitive-C5HbbcEP.js";
import { a as collectBundledChannelConfigs, n as listBundledPluginMetadata } from "./bundled-plugin-metadata-BHkK13pu.js";
import { t as InstallRecordShape } from "./zod-schema.installs-BN5kWUrd.js";
import { t as parseDurationMs } from "./parse-duration-FE5jALAs.js";
import { a as AgentSandboxSchema, c as MemorySearchSchema, d as AgentModelSchema, i as AgentRuntimePolicySchema, n as AgentEmbeddedHarnessSchema, o as ElevatedAllowFromSchema, r as AgentEntrySchema, s as HeartbeatSchema, t as AgentContextLimitsSchema, u as ToolsSchema } from "./zod-schema.agent-runtime-BIWWd7du.js";
import { l as ChannelHeartbeatVisibilitySchema } from "./zod-schema.providers-whatsapp-Bz-FRH5z.js";
...
function getDirectChannelRuntimeSchema(channelId) {
	for (const entry of listBundledPluginMetadata({
		...
		if (collectedRuntime) return collectedRuntime;
	}
}
...
//#endregion
export { appendAllowedValuesHint as a, validateJsonSchemaValue as i, parseNonNegativeByteSize as n, summarizeAllowedValues as o, parseByteSize as r, OpenClawSchema as t };
